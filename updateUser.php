...
<div class="navbar">
  ...
  ?>
    ...
    <div id="main">
     <div id="result">
       <form>
       Name:<input type="text" name="name1" value="<?php foreach($val as $v){
                                                            echo $v['name'];}?>" style="width: 300px;"><br>
       Mobile:<input type="text" name="mobile" value="<?php foreach($val as $v){
                                                            echo $v['mobile'];}?>" style="width: 300px;"><br>
            ...
            $('input[name="submit"]').click(function(){
              ...
              var name=$('input[name="name1"]').val();
               ...
               $.ajax({
                ...
                type: 'post',
                dataType:'json',
                data: { submit:submit,name:name,mobile:mobile},
