...
?></p> 
  ...
  <div class="grid-layout">
    ...
    <div class="item span-2" style="text-align: center;" id="penUser"><h3>Pending Users:</h3><span style="color: green;font-size: 80px;"><?php echo  $_SESSION['pend']=$s2['pend'];?></span></div>
    <div class="item span-2" style="text-align: center;" id="penRide"><h3>Ride Requests:</h3><span style="color: green;font-size: 80px;"><?php echo $_SESSION['request']=$s1['count'];?></span></div>
    <div class="item span-2" style="text-align: center;" id="aprRide"><h3>Confirmed Ride:</h3><span style="color: green;font-size: 80px;"><?php $_SESSION['confirm']=$sq;
    echo $_SESSION['confirm'];?></div>
    <div class="item span-2" style="text-align: center;" id="availLoc"><h3>Available Location:</h3><span style="color: green;font-size: 80px;"><?php $_SESSION['location']=$s['count'];
    echo $_SESSION['location'];?></div>
    <div class="item span-2" style="text-align: center;" id="totalearn"><h3>Total Earnings:</h3><span style="color: green;font-size: 70px;"><?php $_SESSION['earning']=$earn['total'];
    echo "Rs.".$_SESSION['earning'];?></div>
    <div class="item span-2" style="text-align: center;" id="totalloss"><h3>Total Loss:</h3><span style="color: green;font-size: 70px;"><?php $_SESSION['loss']=$loss['loss'];
    echo "Rs.".$_SESSION['loss'];?></div>
    <div class="item span-2" style="text-align: center;" id="loss"><h3>Cancelation:</h3><span style="color: green;font-size: 70px;"><?php $_SESSION['cancel']=$cancel;
